...
R & RStudio can be installed without administrative privileges via FWS Apps-to-go (search for "R Statistical Package"). Rtools will require administrative priveleges but the installation of packages after this initial install will not.
